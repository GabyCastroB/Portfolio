...
import { Code2, Cpu, Layers, Brain, Users, Globe2 } from "lucide-react";
...
const ExperienceSection = () => {
    const experiences = [
        ...
        {
            icon: Users,
            title: "Peer Tutor – Faculty of Engineering",
            company: "National University of Colombia",
            period: "2024 – 2025",
            description:
                "Guided students in electronic systems, control, and programming. Developed learning materials, mentored peers, and contributed to academic support programs that enhance collaborative learning and innovation in engineering education.",
        },
        {
            icon: Code2,
            ...
            <div className="relative container mx-auto px-6 mt-10">
                ...
                <div className="flex flex-col items-center space-y-8 mb-20">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 font-medium tracking-wide text-center max-w-2xl">
                        "Integrating research, teaching, and multilingual collaboration to advance technology and communication."
                    </p>
                </div>
