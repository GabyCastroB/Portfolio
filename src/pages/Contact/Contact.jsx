                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className="text-gray-300 text-lg">
                                    I’m always open to new opportunities and collaborations related to electronics, artificial intelligence, or software development.
                                    If you’d like to work together or discuss a project, feel free to send me a message — I’ll get back to you as soon as possible
                                </p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">gcastrob@unal.edu.co</p>
                                    </div>
                                </div>
